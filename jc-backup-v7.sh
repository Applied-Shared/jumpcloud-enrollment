#!/bin/bash
#
# JumpCloud Pre-Enrollment Script — V7
#
...
#
#   curl -fsSL "https://raw.githubusercontent.com/Applied-Shared/jumpcloud-enrollment/main/jc-backup-v7.sh" -o jc-backup.sh && chmod +x jc-backup.sh && ./jc-backup.sh
